...
![A query matching an external tutorial returns a result after change](../assets/img/2026-08-27-extending-semantic-search-to-my-work-published-elsewhere/after-external-search.png)
...
![placeholder: a portfolio card showing the new description text under its title](../assets/img/2026-08-27-extending-semantic-search-to-my-work-published-elsewhere/card-description.png)
