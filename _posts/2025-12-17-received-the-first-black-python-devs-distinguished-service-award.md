...
pin: true
image:
  path: /assets/img/cover-images/received-the-first-black-python-devs-distinguished-service-award.jpg
  alt: Cover image showing the words “Black Python Devs” in bold text.
published: true
---

In November 2025, I received an email from [Black Python Devs (BPD)](https://blackpythondevs.com/) leadership informing me that I’m the recipient of the first **Black Python Devs Distinguished Service Award**. The email, signed by founder [Jay Miller](https://www.linkedin.com/in/kjaymiller/) and the leadership team, recognized my “extraordinary commitment and outstanding contributions” to the community and noted that my “dedication, leadership, and impact have made a meaningful difference.”
